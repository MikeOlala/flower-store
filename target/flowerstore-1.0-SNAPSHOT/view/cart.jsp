...
<body id="wandave-theme" class="index" data-theme="tbag-fashion">
     ...
     <div class="container" id="mainContent">
        ...
        <p class="subtitle">Hoa tươi mỗi ngày — Đóng gói cẩn thận, giao trong 2–4h nội thành.</p>
        ...
        <div class="grid">
            ...
            <aside class="card summary">
                ...
                <div class="code">
                    ...
                    <button class="btn secondary" onclick="applyDiscount()">Áp dụng</button>
                </div>
                ...
                <div class="actions">
                    ...
                    <button class="btn" onclick="showAICardModal()">Tạo thiệp tự động</button>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div style="margin-top: 16px; padding: 16px; background: #faf3ea; border-radius: 12px;">
                    <strong>Tổng tiền: <span id="confirmTotal" style="color: var(--rose);">0₫</span></strong>
                </div>
            </div>
    ...
    <div class="modal-overlay" id="invoiceModal">
        <div class="modal-content" style="max-width: 700px;">
            ...
            <div class="modal-actions">
                <button class="btn secondary" onclick="printInvoice()">In hóa đơn</button>
        ...
        <div class="ai-card">
            ...
            <div class="ai-grid">
                ...
                <div>
                    ...
                    <div class="ai-row">
                        <div class="ai-field">
                            ...
                            <select id="aiOccasion">
                                ...
                                <option value="an ủi">An ủi</option>
                            </select>
                        </div>
                        <div class="ai-field">
                    ...
                    <div class="ai-field">
                        <label>Lời nhắn thủ công (tùy chọn)</label>
                        <textarea id="aiManual" rows="3"
                            placeholder="Nếu đã ghi lời chúc ở ô 'Ghi lời chúc kèm bó hoa', bấm 'Lấy lời nhắn từ giỏ' để dùng lại."></textarea>
                        <div class="ai-actions">
                            <button class="ai-btn secondary" onclick="grabNoteFromCart()">Lấy lời nhắn từ giỏ</button>
                            <span class="ai-hint">Mẹo: để trống phần này nếu muốn AI tự sinh toàn bộ.</span>
                        </div>
                    </div>

                    <div class="ai-actions">
                        <button class="ai-btn" onclick="generateMessage()">Sinh lời chúc</button>
                        <button class="ai-btn secondary" onclick="renderCard()">Tạo thiệp</button>
                        <button class="ai-btn secondary" onclick="downloadCard()">Tải PNG</button>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <p class="ai-hint" style="margin-top:8px">
                        Thiệp dùng tông nâu ấm của trang, kèm hoa 🌸·🌷.<br>Hình xuất PNG 900×600.
                    </p>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        function renderCart() {
            ...
            container.innerHTML = cartItems.map(item => `
                <div class="cart-row">
                    ...
                    <div>
                        <div class="remove" onclick="removeItem(${item.id})" title="Xóa">✕</div>
                    </div>
                </div>
            `).join('');
                    ...
                    ${cartItems.map(item => `
                        <div class="invoice-item">
                            <div class="invoice-item-info">
                                ...
                                <div class="invoice-item-meta">${item.meta} × ${item.quantity}</div>
                            </div>
        ...
        function buildMessage() {
            ...
            const bouquet = count ? `bó ${count > 1 ? count + ' loại hoa' : 'hoa'} ${names[0] ?? ''}`.trim() : 'bó hoa';
            ...
            const openers = {
                ...
                'hài hước': [
                    ...
                    `${to} ơi, mở quà trước, cảm động sau nha!`
                ],
                'trang trọng': [
                    `Kính gửi ${to},`,
                    `Trân trọng gửi ${to},`,
        ...
        function initializeCanvas() {
            drawCard('Gõ thông tin ở trái, bấm "Sinh lời chúc" rồi "Tạo thiệp" để xem trước.\n\n🌼 Gợi ý: nhập Người nhận, chọn Dịp & Giọng điệu.', false);
        }
