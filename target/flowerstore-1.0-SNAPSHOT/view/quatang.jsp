...
<head>
  ...
  <style>
    ...
    /* Bá»c pháº§n danh sÃ¡ch, ná»n tráº¯ng â€“ sáº¡ch */
    ...
    /* Layout khi mÃ n hÃ¬nh lá»›n: áº£nh trÃ¡i â€“ info pháº£i */
...
<body id="wandave-theme" class="index" data-theme="tbag-fashion">
  ...
  <main>
    ...
    <h3 class="text-center fs-2">SET QUÃ€ & HOA</h3>
        ...
        <div class="col-12" data-aos="fade-up">
          ...
          <div class="product-card-modern">
            ...
            <div class="product-img-box">
              ...
              <img src="https://cdn.hstatic.net/products/200000846175/stacked-2_bg_cleaned_b8ccbe07d4f849fb80d5a8efb46423cd_1024x1024.jpg"

                alt="Set Hoa & QuÃ  Nimai">

              <div class="quick-view-btn">Xem nhanh</div>
            ...
            <div class="product-info">
              ...
              <div class="product-meta-top">
                ...
                <div class="product-price">690.000â‚«</div>

                <span class="badge-occasion">PhÃ¹ hợp: Sinh nháº­t, cảm Æ¡n</span>

              </div>



              <h5 class="product-title">Set Hoa &amp; QuÃ  Nimai</h5>

              <p class="product-subtitle">Tone be - há»“ng nháº¹, hÆ°Æ¡ng thÆ¡m tinh táº¿.</p>



              <div class="rating">â˜…â˜…â˜…â˜…â˜… <span class="text-muted ms-1">(128 Ä‘Ã¡nh giÃ¡)</span></div>



              <div class="product-features">

                <span><i class="bi bi-truck"></i>Giao trong 2h ná»™i thÃ nh</span>

                <span><i class="bi bi-clock"></i>Chuáº©n bá»‹ ~30 phút</span>

                <span><i class="bi bi-gift"></i>Thiá»‡p viết tay miá»…n phÃ­</span>
              ...
              <p class="product-desc">
                ...
                Set quÃ  káº¿t hợp hoa tÆ°Æ¡i vÃ  quÃ  tặng nhá», phÃ¹ hợp gá»­i tặng ngÆ°á»i thÃ¢n, báº¡n bÃ¨ trong các

                dá»‹p má»«ng,

                cảm Æ¡n hhoặc chúc má»«ng nhá» xinh. Phong cách tá»‘i giáº£n, sang nhưng khÃ´ng quÃ¡ cầu ká»³.
              ...
              <div class="product-actions">
                ...
                <button class="btn btn-dark product-btn-main">

                  <i class="bi bi-bag-plus me-1"></i>ThÃªm vÃ o giờ

                </button>

                <button class="btn btn-outline-dark product-btn-outline">

                  Xem chi tiáº¿t

                </button>

                <button class="btn btn-outline-secondary product-btn-outline">

                  <i class="bi bi-heart me-1"></i>YÃªu thÃ­ch
        ...
        <div class="col-12" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="product-card-modern">
            ...
            <div class="product-img-box">
              ...
              <img src="https://cdn.hstatic.net/products/200000846175/stcked-6_78b3da3372454315b4d7d1798804ae6b_1024x1024.jpg"

                alt="Set Hoa Há»“ng Pháº¥n">
            ...
            <div class="product-info">
              ...
              <div class="product-meta-top">
                ...
                <div class="product-price">750.000â‚«</div>

                <span class="badge-occasion">PhÃ¹ hợp: Ká»· niá»‡m, tặng ngÆ°á»i yêu</span>

              </div>



              <h5 class="product-title">Set Hoa Há»“ng Pháº¥n</h5>

              <p class="product-subtitle">Gam há»“ng pastel nháº¹, ná»¯ tÃ­nh vÃ  lÃ£ng mạn.</p>



              <div class="rating">â˜…â˜…â˜…â˜…â˜† <span class="text-muted ms-1">(236 Ä‘Ã¡nh giÃ¡)</span></div>



              <div class="product-features">

                <span><i class="bi bi-truck"></i>Miá»…n phÃ­ giao ná»™i thÃ nh</span>

                <span><i class="bi bi-emoji-heart-eyes"></i>Best-seller 6 thÃ¡ng liá»n</span>

                <span><i class="bi bi-shield-check"></i>Báº£o quáº£n 2â€“3 ngÃ y</span>
              ...
              <p class="product-desc">
                ...
                Thiáº¿t káº¿ táº­p trung vÃ o hoa há»“ng pháº¥n phá»‘i cÃ¹ng các loáº¡i phá»¥ kiá»‡n tÃ´ng nude, táº¡o cảm giác

                má»m máº¡i,

                ngá»t ngÃ o. LÃ½ tÆ°á»Ÿng cho các dá»‹p ká»· niá»‡m, tá» tÃ¬nh hhoặc gá»­i lá»i yêu thÆ°Æ¡ng dá»‹u dÃ ng.
        ...
        <div class="col-12" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="product-card-modern">
            ...
            <div class="product-img-box">
              ...
              <span class="product-tag tag-best">Trending</span>

              <div class="wishlist-btn"><i class="bi bi-heart"></i></div>

              <img src="https://cdn.hstatic.net/products/200000846175/stacked_2_bg_cleaned_bafc80e7cce44325b1a3bd350d129877_1024x1024.jpg"

                alt="Set Hoa Xanh Biá»ƒn">
            ...
            <div class="product-info">
              ...
              <div class="product-meta-top">
                ...
                <div class="product-price">820.000â‚«</div>

                <span class="badge-occasion">PhÃ¹ hợp: Khai trÆ°Æ¡ng, chúc má»«ng</span>

              </div>



              <h5 class="product-title">Set Hoa Xanh Biá»ƒn</h5>

              <p class="product-subtitle">Sáº¯c xanh hiá»‡n Ä‘áº¡i, sang vÃ  ráº¥t trendy.</p>



              <div class="rating">â˜…â˜…â˜…â˜…â˜… <span class="text-muted ms-1">(98 Ä‘Ã¡nh giÃ¡)</span></div>



              <div class="product-features">

                <span><i class="bi bi-lightning-charge"></i>Äáº·t trước 3h Ä‘á»ƒ giao trong ngÃ y</span>

                <span><i class="bi bi-recycle"></i>Há»™p quÃ  tÃ¡i cháº¿ thÃ¢n thiá»‡n mÃ´i trÆ°á»ng</span>

                <span><i class="bi bi-stars"></i>Phong cách decor Báº¯c Ã‚u</span>
              ...
              <p class="product-desc">
                ...
                TÃ´ng xanh biá»ƒn káº¿t hợp be â€“ tráº¯ng, táº¡o cảm giác hiá»‡n Ä‘áº¡i, tinh táº¿, phÃ¹ hợp cho các dá»‹p

                chúc má»«ng,

                khai trÆ°Æ¡ng hhoặc tặng Ä‘á»‘i tÃ¡c. Thiáº¿t káº¿ nháº¥n vÃ o sá»± sang trá»ng, gá»n gÃ ng, khÃ´ng quÃ¡ rÆ°á»m
