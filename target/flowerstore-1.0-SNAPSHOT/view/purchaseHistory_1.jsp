...
<div class="main-container">
    ...
    <aside class="sidebar">
        ...
        <div class="order-summary">
            ...
            <div class="summary-item"><span>Tổng số đơn:</span><strong>3</strong></div>
            <div class="summary-item"><span>Đã giao:</span><strong>2</strong></div>
            <div class="summary-item"><span>Đang giao:</span><strong>1</strong></div>
            <div class="summary-item"><span>Đã hủy:</span><strong>0</strong></div>
        </div>
        ...
        <div class="tips">
            💡 <strong>Mẹo:</strong> Mua thêm 5 đơn nữa để nhận <b>voucher 10%</b>!
        </div>
    </aside>
