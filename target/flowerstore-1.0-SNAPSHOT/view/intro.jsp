...
<head>
    ...
    <meta name="description" content="Khám phá câu chuyện về Tiệm Hoa Nhà Tớ. Nơi cảm xúc nảy mầm và cuộc sống được tô điểm bằng những đóa hoa tươi đẹp." />
    ...
    <style>
        * {
        ...
        .story-highlight {
            background: linear-gradient(135deg, rgba(201, 147, 102, 0.1), rgba(170, 106, 63, 0.1));
            padding: 2rem;
            border-radius: 16px;
        ...
        .process-section {
            padding: 5rem 0;
            background: linear-gradient(135deg, rgba(201, 147, 102, 0.05), rgba(170, 106, 63, 0.05));
        }
    ...
    <link href="https://fonts.googleapis.com/css2?family=Crimson Text:ital,wght@0,300;0,400;0,500;0,600;0,700;1,400;1,500;1,600;1,700&display=fallback"
...
<main>
    ...
    <section class="about-hero">
        ...
        <div class="hero-content" data-aos="fade-up">
            ...
            <p class="hero-description">Cuộc sống tươi đẹp - Nơi cảm xúc nảy mầm</p>
        </div>
    </section>
        ...
        <div class="about-container">
            <div class="story-grid">
                <div class="story-image" data-aos="fade-right">
                    <img src="https://cdn.hstatic.net/files/200000846175/file/z5318389113228_bf05d1d394f756ddf038d8894726eb4c_cf4c6b6a880841b6b51d904a62b0035c.jpg"
                         alt="Tiệm Hoa Nhà Tớ">
                </div>
                <div class="story-content" data-aos="fade-left">
                    <h2>Câu Chuyện Của Chúng Tôi</h2>
                    <p>
                        Tại <strong>Tiệm Hoa Nhà Tớ</strong>, chúng tôi tin rằng cuộc sống là những khoảnh khắc đẹp.
                        Hoa không chỉ là một món quà, mà là một ngôn ngữ tinh tế để kể những câu chuyện cảm xúc,
                        kết nối yêu thương và tôn vinh vẻ đẹp trong cuộc sống hàng ngày.
                    </p>
                    <p>
                        Được thành lập với niềm đam mê về nghệ thuật cắm hoa và mong muốn mang lại những trải nghiệm
                        đặc biệt cho khách hàng, chúng tôi không ngừng sáng tạo và đổi mới để mỗi bó hoa đều mang
                        một ý nghĩa riêng, một câu chuyện riêng.
                    </p>
                    <div class="story-highlight">
                        <p>
                            "Mỗi đóa hoa là một lời chúc, mỗi bó hoa là một câu chuyện.
                            Chúng tôi không chỉ bán hoa, chúng tôi tạo nên những kỷ niệm đáng nhớ."
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="about-container">
            ...
            <div class="values-grid">
                <div class="value-card" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <p>
                        Liên tục cập nhật xu hướng cắm hoa quốc tế, từ phong cách tối giản, thanh lịch
                        đến các thiết kế theo mùa, đảm bảo bó hoa của bạn luôn thời thượng và độc đáo.
                    </p>
                </div>
                <div class="value-card" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <p>
                        Hoa được nhập trực tiếp từ các vườn chọn lọc, đảm bảo độ tươi mới tuyệt đối.
                        Chúng tôi ưu tiên sử dụng các vật liệu gói thân thiện với môi trường.
                    </p>
                </div>
                <div class="value-card" data-aos="fade-up" data-aos-delay="300">
                    ...
                    <p>
                        Mỗi thiết kế là độc bản, dựa trên câu chuyện, ngân sách và sở thích riêng của người nhận.
                        Chúng tôi không chỉ bán hoa, chúng tôi kiến tạo trải nghiệm.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="about-container">
            <div class="team-intro">
                <div class="team-intro-content" data-aos="fade-right">
                    ...
                    <p>
                        Đội ngũ Florist (nghệ nhân hoa) tại Tiệm Hoa Nhà Tớ là những người trẻ, đam mê và giàu sáng tạo,
                        luôn cắm hoa bằng cả trái tim và sự tỉ mỉ.
                    </p>
                    <p>
                        Chúng tôi mong muốn trở thành thương hiệu hoa được yêu thích, là nơi khách hàng tìm đến không chỉ để mua hoa,
                        mà còn để tìm kiếm sự bình yên và vẻ đẹp tinh tế.
                    </p>
                </div>
                <div class="team-image" data-aos="fade-left">
                    <img src="https://images.unsplash.com/photo-1522543558187-768b6df7c25c?w=600"
        ...
        <div class="about-container">
            ...
            <div class="gallery-grid">
                <div class="gallery-item" data-aos="zoom-in" data-aos-delay="100">
                    <img src="https://cdn.hstatic.net/files/200000846175/file/caf51f824f9dc2c39b8c.jpg"
                         alt="Bó hoa pastel">
                ...
                <div class="gallery-item" data-aos="zoom-in" data-aos-delay="200">
                    <img src="https://product.hstatic.net/200000846175/product/w6_57fe7e7ee65f4097aef741ba053a4609.jpg"
                ...
                <div class="gallery-item" data-aos="zoom-in" data-aos-delay="300">
                    <img src="https://images.unsplash.com/photo-1563241527-3004b7be0ffd?w=400"
                         alt="Hoa cưới">
                    <div class="gallery-overlay">
                ...
                <div class="gallery-item" data-aos="zoom-in" data-aos-delay="400">
                    <img src="https://images.unsplash.com/photo-1490750967868-88aa4486c946?w=400"
                ...
                <div class="gallery-item" data-aos="zoom-in" data-aos-delay="200">
                    <img src="https://images.unsplash.com/photo-1455659817273-f96807779a8a?w=400"
                         alt="Hoa hồng">
                    <div class="gallery-overlay">
                ...
                <div class="gallery-item" data-aos="zoom-in" data-aos-delay="300">
                    <img src="https://images.unsplash.com/photo-1487070183336-b863922373d4?w=400"
                         alt="Bó hoa cầm tay">
                    <div class="gallery-overlay">
                ...
                <div class="gallery-item" data-aos="zoom-in" data-aos-delay="400">
                    <img src="https://images.unsplash.com/photo-1591886960571-74d43a9d4166?w=400"
                         alt="Hoa tươi">
                    <div class="gallery-overlay">
    ...
    <section class="cta-section">
        <div class="about-container">
            <div class="cta-content" data-aos="fade-up">
                ...
                <p>
                    Khám phá các bộ sưu tập mới nhất hoặc liên hệ ngay để thiết kế riêng một bó hoa hoàn hảo.
                    Chúng tôi luôn sẵn sàng lắng nghe và biến ý tưởng của bạn thành hiện thực.
                </p>
                <div class="cta-buttons">
                    <a href="product.html" class="cta-btn cta-btn-primary">
                        Khám phá sản phẩm
                        <span>→</span>
                    </a>
...
<script type="text/javascript" src="//cdn.hstatic.net/themes/200000846175/1001403720/14/pluginscript.js?v=245" defer></script>
<script type="text/javascript" src="//cdn.hstatic.net/themes/200000846175/1001403720/14/main-scripts.js?v=245" defer></script>
<script type="text/javascript" src="//cdn.hstatic.net/themes/200000846175/1001403720/14/main-page.js?v=245" defer></script>
