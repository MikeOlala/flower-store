...
<html lang="vi">
  <head>
    ...
    <meta
      name="description"
      content="Trang giới thiệu gi&#250;p kh&#225;ch h&#224;ng hiểu r&#245; hơn về cửa h&#224;ng của bạn. H&#227;y cung cấp th&#244;ng tin cụ thể về việc kinh doanh, về cửa h&#224;ng, th&#244;ng tin li&#234;n hệ. Điều n&#224;y sẽ gi&#250;p kh&#225;ch h&#224;ng cảm thấy tin tưởng khi mua h&#224;ng tr&#234;n website của bạn.Một v&#224;i gợi &#253; cho ná»™i dung trang Giới thiệu:Bạn l&#224; aiGi&#225; trị kinh doanh của bạn l&#224; g&#236;Địa ch"
    />
      ...
      <div class="page-wrapper">
        ...
        <section class="product-card">
          ...
          <div class="product-image-wrapper">
            ...
            <div class="slider-container">
              <div class="slider-track">
                <img
                  src="https://cdn.hstatic.net/products/200000846175/z7039619228663_b582dcb38712353b5eba1a8fa51b8420_af5596a5dd574d8fbb7712373803a638.jpg"
                  alt="Ảnh 1"
                />

                <img
                  src="https://cdn.hstatic.net/products/200000846175/cropped-img_3245-min_54f380d7dc0e46b8aa6bb969da0f9441.jpg"
                  alt="Ảnh 2"
                />
          ...
          <div class="product-info">
            ...
            <p class="product-subtitle">
              Hoa tươi mỗi ngày – Gửi trọn yêu thương tới người bạn thương.
            </p>
            ...
            <div class="product-price">
              ...
              <span class="old">720.000đ</span>
            </div>

            <p class="product-short-desc">
              Bó hoa tone hồng pastel dịu dàng, dành cho những dịp cần nhiều
              năng lượng tích cực: chúc mừng, tốt nghiệp.
            </p>

            <div class="product-meta">
              <div>
                <strong>Tình trạng:</strong> Còn hàng ·
                <span style="color: #1b9a4c">Có thể giao trong ngày</span>
              </div>
            ...
            <p class="product-note">
              Ghi chú mong muốn (màu giấy gói, thiệp kèm lời chúc, thời gian
              giao...) sẽ được nhập ở bước thanh toán.
            </p>
          </div>
        </section>
        ...
        <section class="section-card">
          ...
          <p class="section-subtitle">
            Tiệm hoa nhà tớ chọn hoa vào sáng sớm tại chợ, xử lý và bảo quản kỹ
            để hoa tươi lâu hơn trên tay người nhận.
          </p>
          ...
          <ul class="product-details-list">
            <li>
              <span class="label">Chủ đề:</span> Lãng mạn, dịu dàng, chúc mừng
            </li>

            <li>
              <span class="label">Phù hợp cho:</span> Sinh nhật, kỷ niệm, tỏ
              tình, tốt nghiệp
            </li>

            <li>
              <span class="label">Màu sắc chủ đạo:</span> Hồng pastel, be kem
            </li>

            <li>
              <span class="label">Thời gian bảo quản:</span> 2–4 ngày (tùy điều
              kiện nhiệt độ & chăm sóc)
            </li>

            <li>
              <span class="label">Lưu ý:</span> Màu hoa có thể chênh nhẹ theo
              mùa, nhưng vẫn giữ đúng bố cục & ý nghĩa thiết kế.
            </li>
          </ul>
        </section>
        ...
        <section class="section-card">
          ...
          <div class="review-item">
            ...
            <p class="review-content">
              Hoa lên màu còn xinh hơn ảnh mẫu, giấy gói be pastel nhìn sang lắm
              ạ. Bạn nhân viên hỗ trợ đổi giờ giao rất nhiệt tình. Người nhận
              rất thích.
            </p>
          </div>
          ...
          <div class="review-item">
            ...
            <p class="review-content">
              Hoa tươi, gói đẹp, mùi thơm nhẹ. Mình trừ 1 sao vì shipper đến sớm
              hơn khoảng 10 phút so với dự kiến (nhưng vẫn ok, không ảnh hưởng
              nhiều).
            </p>
          </div>
          ...
          <div class="review-item">
            ...
            <p class="review-content">
              Lần thứ 3 đặt hoa ở Tiệm hoa nhà tớ rồi, vẫn ưng như lần đầu. Mình
              thích nhất là tông màu be hồng này, nhìn rất "healing".
            </p>
          </div>
        </section>
        ...
        <section class="section-card">
          ...
          <p class="section-subtitle">
            Hãy chia sẻ trải nghiệm của bạn để Tiệm hoa nhà tớ có thể phục vụ
            tốt hơn nhé.
          </p>
          ...
          <form class="review-form" action="#" method="post">
            ...
            <div class="form-group">
              ...
              <textarea
                id="review-content"
                name="content"
                placeholder="Bạn cảm thấy thế nào về bó hoa, thời gian giao, thái độ nhân viên..."
              ></textarea>
            </div>

            <div class="form-group">
              <label for="review-purpose">Dịp tặng (không bắt buá»™c)</label>
