    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (success) {
                ...
                // Nếu thanh toán qua VNPay hoặc MoMo, redirect đến trang thanh toán
                if ("vnpay".equals(paymentMethod) || "momo".equals(paymentMethod)) {
                    // TODO: Tích hợp VNPay/MoMo
                    jsonResponse.addProperty("success", true);
                    jsonResponse.addProperty("orderCode", order.getOrderCode());
                    jsonResponse.addProperty("redirectUrl", request.getContextPath() + "/view/orderSuccess.jsp?orderCode=" + order.getOrderCode());
                } else {
                    jsonResponse.addProperty("success", true);
                    jsonResponse.addProperty("orderCode", order.getOrderCode());
