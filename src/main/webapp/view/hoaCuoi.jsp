...
<head>
  ...
  <style>
    ...
    :root {
      ...
      --shadow-soft: 0 4px 20px rgba(60, 41, 34, 0.08);

      --shadow-medium: 0 8px 30px rgba(60, 41, 34, 0.12);

      --shadow-strong: 0 12px 40px rgba(60, 41, 34, 0.18);
    ...
    * {
    ...
    .product-hero {
      ...
      background: linear-gradient(135deg, #d4a574 0%, var(--accent) 50%, var(--accent-dark) 100%);
...
<main>
  ...
  <section class="product-hero">
    ...
    <div class="product-hero-inner">
      ...
      <h1 class="product-title">Hoa Cưới</h1>
  ...
  <div class="product-wrapper">
    ...
    <div class="products-grid">
      ...
      <article class="product-card" data-title="Aurora" data-price="650.000đ"
           ...
           data-img="https://product.hstatic.net/200000846175/product/500_392a4a18b84c493db6a4604d88d87fba.jpg"

           data-tags="Pastel, Dịu dàng, Sinh nhật, Kỷ niệm">

        <img class="product-image"

           src="https://product.hstatic.net/200000846175/product/500_392a4a18b84c493db6a4604d88d87fba.jpg"
