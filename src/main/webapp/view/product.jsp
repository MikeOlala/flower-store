...
<main>
  ...
  <section class="product-hero">
    ...
    <div class="product-hero-inner">
      ...
      <h1 class="product-title">Bá»™ sÆ°u táº­p</h1>
  ...
  <div class="product-wrapper">
    ...
    <div class="products-grid">
      ...
      <article class="product-card" data-title="Pastel Morning" data-price="650.000Ä‘" data-price-value="650000"
      ...
      <article class="product-card" data-title="Sunset Vibes" data-price="780.000Ä‘"

           data-price-value="780000" data-color="warm"
      ...
      <article class="product-card" data-title="Secret Love" data-price="890.000Ä‘"

           data-price-value="890000" data-color="warm"
      ...
      <article class="product-card" data-title="Rustic Garden" data-price="720.000Ä‘"

           data-price-value="720000" data-color="rustic"
      ...
      <article class="product-card" data-title="Gentle Day" data-price="590.000Ä‘"

           data-price-value="590000" data-color="neutral"
        ...
        <div class="product-body">
          ...
          <div class="product-tags">
            ...
            <span class="tag">ThÄƒm ngÆ°á»i thÃ¢n</span>
      ...
      <article class="product-card" data-title="New Chapter" data-price="980.000Ä‘"

           data-price-value="980000" data-color="warm"
      ...
      <article class="product-card" data-title="Soft Cloud" data-price="630.000Ä‘"

           data-price-value="630000" data-color="neutral"
      ...
      <article class="product-card" data-title="Blush Story" data-price="710.000Ä‘"

           data-price-value="710000" data-color="pastel"
      ...
      <article class="product-card" data-title="Tiny Joy" data-price="490.000Ä‘" data-price-value="490000"
        ...
        <div class="product-body">
          ...
          <div class="product-tags">
            ...
            <span class="tag">Dá»… thÆ°Æ¡ng</span>
      ...
      <article class="product-card" data-title="Midnight Bloom" data-price="1.050.000Ä‘"
        ...
        <div class="product-body">
          ...
          <div class="product-tags">
            ...
            <span class="tag">Buá»•i tá»‘i</span>
      ...
      <article class="product-card" data-title="Peach Garden" data-price="740.000Ä‘"

           data-price-value="740000" data-color="pastel"
      ...
      <article class="product-card" data-title="Rustic Field" data-price="760.000Ä‘"

           data-price-value="760000" data-color="rustic"
      ...
      <article class="product-card" data-title="Mini Cheer" data-price="450.000Ä‘"

           data-price-value="450000" data-color="bright"
      ...
      <article class="product-card" data-title="Pastel Cloud" data-price="700.000Ä‘"

           data-price-value="700000" data-color="pastel"
      ...
      <article class="product-card" data-title="Warm Congrats" data-price="900.000Ä‘"

           data-price-value="900000" data-color="warm"
      ...
      <article class="product-card" data-title="Little Secret" data-price="520.000Ä‘"

           data-price-value="520000" data-color="pastel"
      ...
      <article class="product-card" data-title="Rustic Corner" data-price="780.000Ä‘"

           data-price-value="780000" data-color="rustic"
      ...
      <article class="product-card" data-title="Pastel Hug" data-price="830.000Ä‘"

           data-price-value="830000" data-color="pastel"
      ...
      <article class="product-card" data-title="Candy Pastel" data-price="690.000Ä‘"

           data-price-value="690000" data-color="pastel"
      ...
      <article class="product-card" data-title="Golden Day" data-price="870.000Ä‘"

           data-price-value="870000" data-color="warm"
      ...
      <article class="product-card" data-title="Forest Rustic" data-price="790.000Ä‘"

           data-price-value="790000" data-color="rustic"
      ...
      <article class="product-card" data-title="Blush Heart" data-price="910.000Ä‘"

           data-price-value="910000" data-color="pastel"
      ...
      <article class="product-card" data-title="Coffee Rustic" data-price="730.000Ä‘"

           data-price-value="730000" data-color="rustic"
      ...
      <article class="product-card" data-title="Tiny Congrats" data-price="480.000Ä‘"

           data-price-value="480000" data-color="bright"
      ...
      <article class="product-card" data-title="Everyday Hug" data-price="600.000Ä‘"

           data-price-value="600000" data-color="neutral"
    ...
    <!-- PAGINATION (hiá»ƒn thá»‹ cho Ä‘áº¹p, chÆ°a báº¯t buá»™c xá»­ lÃ½ JS) -->
  ...
  <div class="product-modal">
    ...
    <div class="modal-body">
      ...
      <div class="modal-meta" id="modalMeta">
        ...
        Thiáº¿t káº¿ bá»Ÿi Tiệm Hoa nhà tớ. Có thể thay Ä‘á»•i một vÃ i loáº¡i hoa theo mÃ¹a mÃ  váº«n giữ Ä‘Ãºng tinh tháº§n bÃ³ hoa.
...
<!-- JS: xá»­ lÃ½ click card â†’ má»Ÿ modal + filter + collection tabs -->
...
<script>
  ...
  // FILTER LOGIC â€“ gá»n, káº¿t hợp collection tab
  ...
  function applyFilters() {
    ...
    cards.forEach(card => {
      ...
      // NhÃ³m collection (giờ‘ng các web xu hÆ°á»›ng)
      ...
      if (activeCollection === 'pastel') {
        ...
        matchesCollection = tagsHas('size nhá»');

      } else if (activeCollection === 'celebrate') {

        matchesCollection = tagsHas('chúc má»«ng') || tagsHas('khai trÆ°Æ¡ng');
      ...
      if (matchesTopic && matchesColor && matchesPrice && matchesCollection) {
