        ...
        <div class="header-right">
          <div class="user-info">
            ...
            <div>
              ...
              <div
                class="user-role"
                style="font-size: 0.85rem; color: var(--brown-soft)"
              >
                Administrator
              </div>
            </div>
              ...
              <div class="card-body">
                <div class="progress-container">
                  ...
                  <div class="progress-bar">
                    <div
                      class="progress-fill"
                      style="width: 45%; background-color: var(--accent)"
                    ></div>
                  </div>
                </div>
                ...
                <div class="progress-container">
                  ...
                  <div class="progress-bar">
                    <div
                      class="progress-fill"
                      style="width: 32%; background-color: #6a994e"
                    ></div>
                  </div>
                </div>
                ...
                <div class="progress-container">
                  ...
                  <div class="progress-bar">
                    <div
                      class="progress-fill"
                      style="width: 75%; background-color: #386641"
                    ></div>
                  </div>
                </div>
                ...
                <div class="progress-container">
                  ...
                  <div class="progress-bar">
                    <div
                      class="progress-fill"
                      style="width: 8%; background-color: #e76f51"
                    ></div>
                  </div>
                </div>
              </div>
          ...
          <div class="form-row">
            <div class="card" style="flex: 1">
              <div class="card-header">
                ...
                <button class="btn btn-primary btn-sm" id="viewAllOrders">
                  Xem Tất Cả
                </button>
              </div>
                ...
                <table>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <span class="status status-active">Đang giao</span>
                      </td>
                      ...
                      <td class="action-buttons">
                        ...
                        <button class="btn btn-success btn-sm edit-order">
              ...
              <table>
                ...
                <tbody>
                  <tr>
                    <td>
                      <div
                        style="
                          width: 50px;
                          height: 50px;
                          background: linear-gradient(135deg, #f4e1d1, #e9d2bd);
                          border-radius: 8px;
                          display: flex;
                          align-items: center;
                          justify-content: center;
                    ...
                    <td class="action-buttons">
                      <button class="btn btn-primary btn-sm view-product">
                        <i class="fas fa-eye"></i>
                      </button>
        ...
        <div id="orders" class="content-section">
          <div class="card">
            <div class="card-header">
              ...
              <div>
                <button class="btn btn-light" id="filterOrders">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="action-buttons">
                      ...
                      <button class="btn btn-warning btn-sm complete-order">
              ...
              <table>
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="action-buttons">
                      <button class="btn btn-primary btn-sm view-customer">
                        <i class="fas fa-eye"></i>
                      </button>

                      <button class="btn btn-success btn-sm edit-customer">
                        <i class="fas fa-edit"></i>
                      </button>
                  ...
                  <div class="card-body">
                    <div class="progress-container">
                      ...
                      <div class="progress-bar">
                        <div
                          class="progress-fill"
                          style="width: 42%; background-color: var(--accent)"
                        ></div>
                      </div>
                    </div>
                    ...
                    <div class="progress-container">
                      ...
                      <div class="progress-bar">
                        <div
                          class="progress-fill"
                          style="width: 28%; background-color: #e9c46a"
                        ></div>
                      </div>
                    </div>
                    ...
                    <div class="progress-container">
                      ...
                      <div class="progress-bar">
                        <div
                          class="progress-fill"
                          style="width: 18%; background-color: #6a994e"
                        ></div>
                      </div>
                    </div>
                    ...
                    <div class="progress-container">
                      ...
                      <div class="progress-bar">
                        <div
                          class="progress-fill"
                          style="width: 12%; background-color: #4cc9f0"
                        ></div>
                      </div>
                    </div>
                  </div>
              ...
              <table>
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="action-buttons">
                      <button class="btn btn-primary btn-sm view-promotion">
                        <i class="fas fa-eye"></i>
                      </button>

                      <button class="btn btn-success btn-sm edit-promotion">
                        <i class="fas fa-edit"></i>
                      </button>
          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="tabs" id="settingsTabs">
                <div class="tab active" data-setting="store">
                  Thông Tin Cửa Hàng
                </div>
              ...
              <div class="form-row">
                <div class="form-group">
                  ...
                  <input
                    type="email"
                    class="form-control"
                    value="contact@tienghoanhato.com"
                  />
                </div>
                ...
                <div class="form-group">
                  ...
                  <input
                    type="text"
                    class="form-control"
                    value="123 Đường Hoa, Quận 1, TP.HCM"
                  />
                </div>
              </div>
...
Tiệm Hoa nhà tớ chuyên cung cấp các loại hoa tươi, bó hoa đẹp với giá cả hợp lý. Chúng tôi cam kết mang đến cho khách hàng những sản phẩm chất lượng nhất.</textarea
                >
              </div>
    ...
    <div class="notification" id="notification">
      ...
      <div>
        ...
        <div
          style="font-size: 0.9rem; color: var(--brown-soft)"
    ...
    <script>
      ...
      function initializeApp() {
        ...
        document
          .querySelectorAll(
            ".view-order, .edit-order, .delete-product, .view-product, .edit-product, .complete-order, .cancel-order"
          )
          .forEach((btn) => {
        ...
        document
          ...
          .addEventListener("click", function () {
            ...
            document
              .querySelector('.menu-item[data-target="orders"]')
