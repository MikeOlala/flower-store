...
<html lang="vi">
  <head>
    ...
    <link
      rel="stylesheet"
      href="../../MDB5-STANDARD-UI-KIT-Free-9.2.0 (1)/css/mdb.min.css"
    />
  ...
  <body>
    ...
    <div
      class="header d-flex align-items-center justify-content-between px-3 py-2"
    >
      <a href="profileCustomer.jsp" class="text-white fs-5"
    ...
    <div id="nameModal" class="custom-modal" aria-hidden="true">
      <div class="modal-content">
        ...
        <div class="d-flex justify-content-end">
          <button
            class="btn-save"
            onclick="saveField('nameModal','Tên','nameInput')"
          >
            Lưu
          </button>
        </div>
    ...
    <div id="bioModal" class="custom-modal" aria-hidden="true">
      <div class="modal-content">
        ...
        <div class="d-flex justify-content-end">
          <button
            class="btn-save"
            onclick="saveField('bioModal','Bio','bioInput')"
          >
            Lưu
          </button>
        </div>
    ...
    <div id="genderModal" class="custom-modal" aria-hidden="true">
      <div class="modal-content">
        ...
        <div class="d-flex justify-content-end">
          <button
            class="btn-save"
            onclick="saveField('genderModal','Giới tính','genderInput')"
          >
            Lưu
          </button>
        </div>
    ...
    <div id="birthModal" class="custom-modal" aria-hidden="true">
      <div class="modal-content">
        ...
        <div class="d-flex justify-content-end">
          <button
            class="btn-save"
            onclick="saveField('birthModal','Ngày sinh','birthInput')"
          >
            Lưu
          </button>
        </div>
    ...
    <div id="phoneModal" class="custom-modal" aria-hidden="true">
      <div class="modal-content">
        ...
        <div class="d-flex justify-content-end">
          <button
            class="btn-save"
            onclick="saveField('phoneModal','Số điện thoại','phoneInput')"
          >
            Lưu
          </button>
        </div>
    ...
    <div id="emailModal" class="custom-modal" aria-hidden="true">
      <div class="modal-content">
        ...
        <div class="d-flex justify-content-end">
          <button
            class="btn-save"
            onclick="saveField('emailModal','Email','emailInput')"
          >
            Lưu
          </button>
        </div>
