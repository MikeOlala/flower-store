...
<main>
  ...
  <section class="product-hero">
    ...
    <div class="product-hero-inner">
      ...
      <h1 class="product-title">Hoa Giáº¥y</h1>
  ...
  <div class="product-wrapper">
    ...
    <div class="products-grid">
      ...
      <article class="product-card" data-title="Aurora" data-price="650.000Ä‘"
           ...
           data-img="https://product.hstatic.net/200000846175/product/beautiful_ocean_0ac948aa895d4de48ca0942f63b53c3d.jpg"

           data-tags="Pastel, Dá»‹u dÃ ng, Sinh nháº­t, Ká»· niá»‡m">

        <img class="product-image"

           src="https://product.hstatic.net/200000846175/product/beautiful_ocean_0ac948aa895d4de48ca0942f63b53c3d.jpg"
        ...
        <div class="product-body">
          ...
          <div class="product-tags">
            ...
            <span class="tag">Hoa giáº¥y</span>
      ...
      <article class="product-card" data-title="Sunset Vibes" data-price="780.000Ä‘" data-price-value="780000"
           ...
           data-img="https://flowercorner.b-cdn.net/image/cache/catalog/products/B%C3%B3%20Hoa/thanh-xuan.jpg.webp"

           data-tags="Cam vÃ ng, NÄƒng lÆ°á»£ng, ChÃºc má»«ng, Tá»‘t nghiá»‡p">

        <img class="product-image"

           src="https://flowercorner.b-cdn.net/image/cache/catalog/products/B%C3%B3%20Hoa/thanh-xuan.jpg.webp"
