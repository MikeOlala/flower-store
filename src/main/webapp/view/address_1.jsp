...
<head>
    ...
    <!-- CSS riêng -->
    <link rel="stylesheet" href="../assets/address_1.css">
    <!-Đây là code dùng cho header và footer-->
    <style>
        :root {
...
<nav class="breadcrumb">
        ...
        <span>/</span>
        <a href="profileCustomer.html">Trang cá nhân</a>
        <span>/</span>
        <span>Địa chỉ</span>
    </nav>
    ...
    <aside class="sidebar">
        <div class="sidebar-header">
            ...
            <div class="sidebar-info">
                <h4>Customer</h4>
                <p>Thành viên từ 10/2025</p>
                <span class="points">🌸 290 POINTS</span>
            </div>
        </div>
        ...
        <div class="order-summary">
            ...
            <div class="summary-item">
                <span>Đơn hàng:</span><strong>3</strong>
            </div>
            <div class="summary-item">
                <span>Địa chỉ đã lưu:</span><strong>2</strong>
            </div>
        </div>
        ...
        <div class="tips">
            <p>💡 <strong>Mẹo:</strong> Hãy lưu nhiều địa chỉ để chọn nhanh khi thanh toán!</p>
        </div>
    </aside>
