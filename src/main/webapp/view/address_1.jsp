...
<nav class="breadcrumb">
    ...
    <a href="profileCustomer.html">Trang cÃ¡ nhÃ¢n</a>
...
<div class="main-container">
  ...
  <aside class="sidebar">
    ...
    <div class="order-summary">
      ...
      <h5>Tá»•ng quan tÃ i khoáº£n</h5>

      <div class="summary-item">

        <span>ÄÆ¡n hÃ ng:</span><strong>3</strong>

      </div>

      <div class="summary-item">

        <span>Äá»‹a chá»‰ Ä‘Ã£ lÆ°u:</span><strong>2</strong>
    ...
    <div class="tips">
      ...
      <p>ðŸ’¡ <strong>Máº¹o:</strong> HÃ£y lÆ°u nhiá»u Ä‘á»‹a chá»‰ Ä‘á»ƒ chá»n nhanh khi thanh toÃ¡n!</p>
  ...
  <main class="content">
    ...
    <!-- NÃºt quay láº¡i há»“ sÆ¡ -->





    <h3>Äá»‹a chá»‰ giao hÃ ng</h3>
