...
<main>
    ...
    <div class="product-wrapper">
        ...
        <div class="products-grid">
            ...
            <!-- CARD 1 -->
            <article class="product-card" data-title="Pastel Morning" data-price="650.000đ" data-price-value="650000"
                     data-color="pastel"
            ...
            <!-- CARD 2 -->
            <article class="product-card" data-title="Sunset Vibes" data-price="780.000đ"
            ...
            <!-- CARD 3 -->
            <article class="product-card" data-title="Secret Love" data-price="890.000đ"
            ...
            <!-- CARD 4 -->
            <article class="product-card" data-title="Rustic Garden" data-price="720.000đ"
            ...
            <!-- CARD 5 -->
            <article class="product-card" data-title="Gentle Day" data-price="590.000đ"
            ...
            <!-- CARD 6 -->
            <article class="product-card" data-title="New Chapter" data-price="980.000đ"
            ...
            <!-- CARD 7 -->
            <article class="product-card" data-title="Soft Cloud" data-price="630.000đ"
            ...
            <!-- CARD 8 -->
            <article class="product-card" data-title="Blush Story" data-price="710.000đ"
            ...
            <!-- CARD 11 -->
            <article class="product-card" data-title="Peach Garden" data-price="740.000đ"
            ...
            <!-- CARD 14 -->
            <article class="product-card" data-title="Rustic Field" data-price="760.000đ"
            ...
            <!-- CARD 15 -->
            <article class="product-card" data-title="Mini Cheer" data-price="450.000đ"
            ...
            <!-- CARD 16 -->
            <article class="product-card" data-title="Pastel Cloud" data-price="700.000đ"
            ...
            <!-- CARD 17 -->
            <article class="product-card" data-title="Warm Congrats" data-price="900.000đ"
            ...
            <!-- CARD 18 -->
            <article class="product-card" data-title="Little Secret" data-price="520.000đ"
            ...
            <!-- CARD 19 -->
            <article class="product-card" data-title="Rustic Corner" data-price="780.000đ"
            ...
            <!-- CARD 20 -->
            <article class="product-card" data-title="Pastel Hug" data-price="830.000đ"
            ...
            <!-- CARD 22 -->
            <article class="product-card" data-title="Candy Pastel" data-price="690.000đ"
            ...
            <!-- CARD 23 -->
            <article class="product-card" data-title="Golden Day" data-price="870.000đ"
            ...
            <!-- CARD 24 -->
            <article class="product-card" data-title="Forest Rustic" data-price="790.000đ"
            ...
            <!-- CARD 26 -->
            <article class="product-card" data-title="Blush Heart" data-price="910.000đ"
            ...
            <!-- CARD 27 -->
            <article class="product-card" data-title="Coffee Rustic" data-price="730.000đ"
            ...
            <!-- CARD 28 -->
            <article class="product-card" data-title="Tiny Congrats" data-price="480.000đ"
            ...
            <!-- CARD 30 -->
            <article class="product-card" data-title="Everyday Hug" data-price="600.000đ"
    ...
    <div class="product-modal">
        ...
        <div class="modal-body">
            ...
            <div class="modal-meta" id="modalMeta">
                Thiết kế bởi Tiệm Hoa Nhà Tớ. Có thể thay đổi một vài loại hoa theo mùa mà vẫn giữ đúng tinh thần bó hoa.
            </div>
...
<script>
    ...
    function applyFilters() {
        ...
        cards.forEach(card => {
            ...
            // Nhóm collection (giống các web xu hướng)
