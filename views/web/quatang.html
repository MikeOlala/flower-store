...
<head>
   ...
   <style>
        ...
        /* Bọc phần danh sách, nền trắng – sạch */
        .section-wrapper {
            background: #ffffff;
            padding: 32px 24px;
            border-radius: 24px;
        ...
        /* Layout khi màn hình lớn: ảnh trái – info phải */
...
<body id="wandave-theme" class="index" data-theme="tbag-fashion">
    ...
    <main>
        <h3 class="text-center fs-2">SET QUÀ & HOA</h3>
                    ...
                    <div class="product-card-modern">
                        ...
                        <div class="product-info">
                            <div class="product-meta-top">
                                ...
                                <span class="badge-occasion">Phù hợp: Sinh nhật, cảm ơn</span>
                            </div>

                            <h5 class="product-title">Set Hoa &amp; Quà Nimai</h5>
                            <p class="product-subtitle">Tone be - hồng nhẹ, hương thơm tinh tế.</p>

                            <div class="rating">★★★★★ <span class="text-muted ms-1">(128 đánh giá)</span></div>

                            <div class="product-features">
                                <span><i class="bi bi-truck"></i>Giao trong 2h nội thành</span>
                                <span><i class="bi bi-clock"></i>Chuẩn bị ~30 phút</span>
                                <span><i class="bi bi-gift"></i>Thiệp viết tay miễn phí</span>
                            </div>

                            <p class="product-desc">
                                Set quà kết hợp hoa tươi và quà tặng nhỏ, phù hợp gửi tặng người thân, bạn bè trong các
                                dịp mừng,
                                cảm ơn hoặc chúc mừng nhỏ xinh. Phong cách tối giản, sang nhưng không quá cầu kỳ.
                            </p>
                    ...
                    <div class="product-card-modern">
                        ...
                        <div class="product-info">
                            <div class="product-meta-top">
                                ...
                                <span class="badge-occasion">Phù hợp: Kỷ niệm, tặng người yêu</span>
                            </div>

                            <h5 class="product-title">Set Hoa Hồng Phấn</h5>
                            <p class="product-subtitle">Gam hồng pastel nhẹ, nữ tính và lãng mạn.</p>

                            <div class="rating">★★★★☆ <span class="text-muted ms-1">(236 đánh giá)</span></div>

                            <div class="product-features">
                                <span><i class="bi bi-truck"></i>Miễn phí giao nội thành</span>
                                <span><i class="bi bi-emoji-heart-eyes"></i>Best-seller 6 tháng liền</span>
                                <span><i class="bi bi-shield-check"></i>Bảo quản 2–3 ngày</span>
                            </div>

                            <p class="product-desc">
                                Thiết kế tập trung vào hoa hồng phấn phối cùng các loại phụ kiện tông nude, tạo cảm giác
                                mềm mại,
                                ngọt ngào. Lý tưởng cho các dịp kỷ niệm, tỏ tình hoặc gửi lời yêu thương dịu dàng.
                            </p>
                    ...
                    <div class="product-card-modern">
                        ...
                        <div class="product-info">
                            <div class="product-meta-top">
                                ...
                                <span class="badge-occasion">Phù hợp: Khai trương, chúc mừng</span>
                            </div>

                            <h5 class="product-title">Set Hoa Xanh Biển</h5>
                            <p class="product-subtitle">Sắc xanh hiện đại, sang và rất trendy.</p>

                            <div class="rating">★★★★★ <span class="text-muted ms-1">(98 đánh giá)</span></div>

                            <div class="product-features">
                                <span><i class="bi bi-lightning-charge"></i>Đặt trước 3h để giao trong ngày</span>
                                <span><i class="bi bi-recycle"></i>Hộp quà tái chế thân thiện môi trường</span>
                                <span><i class="bi bi-stars"></i>Phong cách decor Bắc Âu</span>
                            </div>

                            <p class="product-desc">
                                Tông xanh biển kết hợp be – trắng, tạo cảm giác hiện đại, tinh tế, phù hợp cho các dịp
                                chúc mừng,
                                khai trương hoặc tặng đối tác. Thiết kế nhấn vào sự sang trọng, gọn gàng, không quá rườm
                                rà.
                            </p>
