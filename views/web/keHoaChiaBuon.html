        ...
        <div class="container my-5">
            <div class="top-title">
                        <h4 class="title-section">
                            <a href="/collections/bo-hoa"><span>KỆ HOA CHIA BUỒN</span></a>
                        </h4>
                        <p>
            ...
            <div class="row g-4">
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="perfume-card shadow-sm">
                        <div class="img-container">
                            <img src="https://down-vn.img.susercontent.com/file/vn-11134207-7r98o-lzjexlt4zm3l0b.webp"
                                alt="Product 1">
                        </div>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="perfume-card shadow-sm">
                        <div class="img-container">
                            <img src="https://hoagiaynhunxoan.com/wp-content/uploads/2020/12/Hoa-huong-duong-sap.jpg"
                                alt="Product 2">
                        </div>
                        <div class="card-body text-center p-4">
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="perfume-card shadow-sm">
                        <div class="img-container">
                            <img src="https://flowercorner.b-cdn.net/image/cache/catalog/products/August%202023/bo-hoa-tulip-khuc-hat.jpg.webp"
                                alt="Product 3">
                        </div>
                        <div class="card-body text-center p-4">
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="perfume-card shadow-sm">
                        <div class="img-container">
                            <img src="https://happyflower.vn/app/uploads/2021/10/BO_CTC_KHO_HONG.jpeg"
                                alt="Product 4">
                        </div>
                        <div class="card-body text-center p-4">
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="perfume-card shadow-sm">
                        <div class="img-container">
                            <img src="https://flowersight.com/wp-content/uploads/2024/08/bo-hoa-bi-kho-2.jpg"
                                alt="Product 5">
                        </div>
                        <div class="card-body text-center p-4">
                            <h5 class="fw-semibold mb-2">Bó hoa Baby's Breath (hoa Bi) khô</h5>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="perfume-card shadow-sm">
                        <div class="img-container">
                            <img src="https://flowersight.com/wp-content/uploads/2024/11/bo-hoa-lavender-2.jpg"
                                alt="Product 6">
                        </div>
                        <div class="card-body text-center p-4">
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="perfume-card shadow-sm">
                        <div class="img-container">
                            <img src="https://i0.wp.com/tiemhoabonmua.com/wp-content/uploads/2021/05/bo-hoa-dong-tien-2.jpg?fit=493%2C690&ssl=1"
                                alt="Product 7">
                        </div>
                        <div class="card-body text-center p-4">
                            <h5 class="fw-semibold mb-2">Bó hoa Đồng tiền nhựa</h5>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="perfume-card shadow-sm">
                        <div class="img-container">
                            <img src="https://product.hstatic.net/1000287394/product/hoa-gia-bo-cong-anh-29cm-hong-phan_7415661de413473c8b6cf947339fe34a_master.png"
                                alt="Product 8">
                        </div>
                        <div class="card-body text-center p-4">
                            <h5 class="fw-semibold mb-2">Chậu hoa Bồ Công Anh lụa</h5>
                            <p class="text-muted small">Ước mơ - Sự tự do - Những lời hứa hẹn</p>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="perfume-card shadow-sm">
                        <div class="img-container">
                            <img src="https://media.loveitopcdn.com/33265/thumb/upload/images/mo-phong-bo-6-hoa-mau-don-lua.jpg"
                                alt="Product 9">
                        </div>
                        <div class="card-body text-center p-4">
