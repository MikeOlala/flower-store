...
<head>
    ...
    <title>La Vie Est Belle ( Flower & Gift) - La Vie Est Belle - Flower & Gift</title>
...
<body id="wandave-theme" class="index" data-theme="tbag-fashion">
    ...
    <main>
       ...
       <section id="section-collection1" class="pd-top-30 d-none-button-mb" data-include="section-collection-1">
                <div class="">
                    <div class="top-title">
                    ...
                    <div id="owl-collection1" class="d-flex-owl slick-callback" data-row="2" data-slides-md="4"
                        data-slides-tablet="3" data-slides-xs="2" data-slides-md-scroll="5"
                        data-slides-tablet-scroll="3" data-slides-xs-scroll="2" data-dots="false" data-autoplay="false"
                        data-infinite="true" data-custom-arrows="true">
                        <div class="d-flex-column">
                            <div class="product-block item">
                                <div class="product-img ">
                                    <a href="/products/fabric-peony" title="Fabric Peony" class="image-resize ">
                                        <img class="lazyload dt-width-100 img-first" width="260" height="260"
                                            src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII="
                                            data-src="https://down-vn.img.susercontent.com/file/vn-11134207-7r98o-lu38qlygfy8vf1.webp"
                                            alt="fabric-peony" />
                                    </a>
                                    ...
                                    <div class="product-icon-action">
                                        <div class="add-to-cart">
                                            <button onclick="Wanda.addtocartmodal(1160110641,1)"
                                                class="inline-block icon-addcart margin_right_10 box-shadow"
                                                href="javascript:void(0)">Thêm vào giỏ</button>
                                        </div>
                                        <div class="quick-view">
                                            <button href="javascript:void(0)" class="btn_quickview icon-quickview"
                                                data-url="/products/fabric-peony">Xem nhanh</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="product-detail">
                                    <h3 class="pro-name">
                                        <a href="/products/fabric-peony" title="Fabric Peony">
                                            Fabric Peony
                                        </a>
                                    </h3>
                        ...
                        <div class="d-flex-column">
                            <div class="product-block item">
                                <div class="product-img ">
                                    <a href="/products/fabric-aster-amellus" title="Fabric Aster Amellus" class="image-resize ">
                                        <img class="lazyload dt-width-100 img-first" width="260" height="260"
                                            src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII="
                                            data-src="https://down-vn.img.susercontent.com/file/vn-11134207-7qukw-lgm5tlnqfy7n4a.webp"
                                            alt="Fabric Aster Amellus" />
                                    </a>
                                    <div class="product-wishlist">
                                        <button data-original-title="Yêu thích" class="wishlist-loop"
                                    ...
                                    <div class="product-icon-action">
                                        <div class="add-to-cart">
                                            <button onclick="Wanda.addtocartmodal(1160366941,1)"
                                                class="inline-block icon-addcart margin_right_10 box-shadow"
                                                href="javascript:void(0)">Thêm vào giỏ</button>
                                        </div>
                                        <div class="quick-view">
                                            <button href="javascript:void(0)" class="btn_quickview icon-quickview"
                                                data-url="/products/fabric-aster-amellus">Xem nhanh</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="product-detail">
                                    <h3 class="pro-name">
                                        <a href="/products/fabric-aster-amellus" title="Fabric Aster Amellus">
                                            Fabric Aster Amellus
                                        </a>
                                    </h3>
                                    <div class="box-pro-prices">
                                        <p class="pro-price">
                        ...
                        <div class="d-flex-column">
                            <div class="product-block item">
                                <div class="product-img ">
                                    <a href="/products/fabric-phalaenopsis" title="Fabric Phalaenopsis" class="image-resize ">
                                        <img class="lazyload dt-width-100 img-first" width="260" height="260"
                                            src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII="
                                            data-src="https://happyflower.vn/app/uploads/2022/04/Lan_3cTrang_LuxuryvoanHong.jpg"
                                            alt="Fabric Phalaenopsis" />
                                    </a>
                                    <div class="product-wishlist">
                                        <button data-original-title="Yêu thích" class="wishlist-loop"
                                    ...
                                    <div class="product-icon-action">
                                        <div class="add-to-cart">
                                            <button onclick="Wanda.addtocartmodal(1160110633,1)"
                                                class="inline-block icon-addcart margin_right_10 box-shadow"
                                                href="javascript:void(0)">Thêm vào giỏ</button>
                                        </div>
                                        <div class="quick-view">
                                            <button href="javascript:void(0)" class="btn_quickview icon-quickview"
                                                data-url="/products/fabric-phalaenopsis">Xem nhanh</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="product-detail">
                                    <h3 class="pro-name">
                                        <a href="/products/fabric-phalaenopsis" title="Fabric Phalaenopsis">
                                            Fabric Phalaenopsis
                                        </a>
                                    </h3>
                                    <div class="box-pro-prices">
                        ...
                        <div class="d-flex-column">
                            <div class="product-block item">
                                <div class="product-img ">
                                    <a href="/products/fabric-rum" title="Fabric Rum" class="image-resize ">
                                        <img class="lazyload dt-width-100 img-first" width="260" height="260"
                                            src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII="
                                            data-src="https://down-vn.img.susercontent.com/file/vn-11134207-7ras8-mbjbullter7o70@resize_w900_nl.webp"
                                            alt="Fabric Rum" />
                                    </a>
                                    <div class="product-wishlist">
                                        <button data-original-title="Yêu thích" class="wishlist-loop"
                                    ...
                                    <div class="product-icon-action">
                                        <div class="add-to-cart">
                                            <button onclick="Wanda.addtocartmodal(1159233018,1)"
                                                class="inline-block icon-addcart margin_right_10 box-shadow"
                                                href="javascript:void(0)">Thêm vào giỏ</button>
                                        </div>
                                        <div class="quick-view">
                                            <button href="javascript:void(0)" class="btn_quickview icon-quickview"
                                                data-url="/products/fabric-rum">Xem nhanh</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="product-detail">
                                    <h3 class="pro-name">
                                        <a href="/products/fabric-rum" title="Fabric Rum">
                                            Fabric Rum
                                        </a>
                                    </h3>
                                    <div class="box-pro-prices">
                        ...
                        <div class="d-flex-column">
                            <div class="product-block item">
                                <div class="product-img ">
                                    <a href="/products/fabric-magnolia" title="Fabric Magnolia" class="image-resize ">
                                        <img class="lazyload dt-width-100 img-first" width="260" height="260"
                                            src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII="
                                            data-src="https://down-vn.img.susercontent.com/file/cn-11134207-7r98o-lwgrb6hnq151c3.webp"
                                            alt="fabric-magnolia" />
                                    </a>
                                    <div class="product-wishlist">
                                        <button data-original-title="Yêu thích" class="wishlist-loop"
                                    ...
                                    <div class="product-icon-action">
                                        <div class="add-to-cart">
                                            <button onclick="Wanda.addtocartmodal(1149015018,1)"
                                                class="inline-block icon-addcart margin_right_10 box-shadow"
                                                href="javascript:void(0)">Thêm vào giỏ</button>
                                        </div>
                                        <div class="quick-view">
                                            <button href="javascript:void(0)" class="btn_quickview icon-quickview"
                                                data-url="/products/fabric-magnolia">Xem nhanh</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="product-detail">
                                    <h3 class="pro-name">
                                        <a href="/products/fabric-magnolia" title="Fabric Magnolia">
                                            Fabric Magnolia
                                        </a>
                                    </h3>
                                    <div class="box-pro-prices">
                        ...
                        <div class="d-flex-column">
                            <div class="product-block item">
                                <div class="product-img ">
                                    <a href="/products/fabric-tithonia" title="Fabric Tithonia" class="image-resize ">
                                        <img class="lazyload dt-width-100 img-first" width="260" height="260"
                                            src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII="
                                            data-src="https://down-vn.img.susercontent.com/file/d63308f6f19875288ded18f5a364dc24.webp"
                                            alt="Fabric Tithonia" />
                                    </a>
                                    <div class="product-wishlist">
                                        <button data-original-title="Yêu thích" class="wishlist-loop"
                                    ...
                                    <div class="product-icon-action">
                                        <div class="add-to-cart">
                                            <button onclick="Wanda.addtocartmodal(1159232990,1)"
                                                class="inline-block icon-addcart margin_right_10 box-shadow"
                                                href="javascript:void(0)">Thêm vào giỏ</button>
                                        </div>
                                        <div class="quick-view">
                                            <button href="javascript:void(0)" class="btn_quickview icon-quickview"
                                                data-url="/products/fabric-tithonia">Xem nhanh</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="product-detail">
                                    <h3 class="pro-name">
                                        <a href="/products/fabric-tithonia" title="Fabric Tithonia">
                                            Fabric Tithonia
                                        </a>
                                    </h3>
                                    <div class="box-pro-prices">
                        ...
                        <div class="d-flex-column">
                            <div class="product-block item">
                                <div class="product-img ">
                                    <a href="/products/fabric-hortensia" title="Fabric Hortensia" class="image-resize ">
                                        <img class="lazyload dt-width-100 img-first" width="260" height="260"
                                            src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII="
                                            data-src="https://down-vn.img.susercontent.com/file/vn-11134207-7ra0g-m7ospadfk6h228.webp"
                                            alt="fabric-hortensia" />
                                    </a>
                                    <div class="product-wishlist">
                                        <button data-original-title="Yêu thích" class="wishlist-loop"
                                    ...
                                    <div class="product-icon-action">
                                        <div class="add-to-cart">
                                            <button onclick="Wanda.addtocartmodal(1122322270,1)"
                                                class="inline-block icon-addcart margin_right_10 box-shadow"
                                                href="javascript:void(0)">Thêm vào giỏ</button>
                                        </div>
                                        <div class="quick-view">
                                            <button href="javascript:void(0)" class="btn_quickview icon-quickview"
                                                data-url="/products/fabric-hortensia">Xem nhanh</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="product-detail">
                                    <h3 class="pro-name">
                                        <a href="/products/fabric-hortensia" title="Fabric Hortensia">
                                            Fabric Hortensia
                                        </a>
                                    </h3>
                                    <div class="box-pro-prices">
                        ...
                        <div class="d-flex-column">
                            <div class="product-block item">
                                <div class="product-img ">
                                    <a href="/products/fabric-cherry" title="Fabric Cherry" class="image-resize ">
                                        <img class="lazyload dt-width-100 img-first" width="260" height="260"
                                            src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII="
                                            data-src="https://down-vn.img.susercontent.com/file/vn-11134207-7ras8-m0ztmjty64db01.webp"
                                            alt="fabric-cherry" />
                                    </a>
                                    <div class="product-wishlist">
                                        <button data-original-title="Yêu thích" class="wishlist-loop"
                                    ...
                                    <div class="product-icon-action">
                                        <div class="add-to-cart">
                                            <button onclick="Wanda.addtocartmodal(1160110628,1)"
                                                class="inline-block icon-addcart margin_right_10 box-shadow"
                                                href="javascript:void(0)">Thêm vào giỏ</button>
                                        </div>
                                        <div class="quick-view">
                                            <button href="javascript:void(0)" class="btn_quickview icon-quickview"
                                                data-url="/products/fabric-cherry">Xem nhanh</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="product-detail">
                                    <h3 class="pro-name">
                                        <a href="/products/fabric-cherry" title="Fabric Cherry">
                                            Fabric Cherry
                                        </a>
                                    </h3>
                                    <div class="box-pro-prices">
    ...
    <script async>
        ...
        let loadslider = () => {
            ...
            $("#home-slider").slick({ slidesToShow: 1, slidesToScroll: 1, autoplay: true, autoplaySpeed: timeSlide, fade: true, speed: 500, arrows: false });
        }
        let loadasyncdefer = () => {
        };
