    ...
    <style>
        * {
        ...
        .news-category {
            ...
            background: linear-gradient(135deg, rgba(201, 147, 102, 0.12), rgba(170, 106, 63, 0.12));
        ...
        <div class="news-layout">
            ...
            <div>
                <section class="news-grid" id="newsGrid">
                    ...
                    <article class="news-card" data-category="tips">
                        ...
                        <div class="news-content">
                            ...
                            <h2 class="news-heading">Gợi ý chọn bó hoa pastel cho những ngày cần sự dịu dàng</h2>
                            <p class="news-excerpt">
                                Tone pastel luôn mang lại cảm giác nhẹ nhàng, trong trẻo – rất hợp để tặng những
                                người
                                mình thương vào dịp sinh nhật, kỷ niệm hoặc đơn giản là "vì nhớ bạn".
                            </p>
                    ...
                    <article class="news-card" data-category="opening">
                        ...
                        <div class="news-content">
                            ...
                            <h2 class="news-heading">Chọn kệ hoa khai trương sao cho tinh tế mà vẫn sang trọng?</h2>
                            <p class="news-excerpt">
                                Không phải cứ thật to là sẽ đẹp – đôi khi một kệ hoa vừa phải, phối màu chuẩn và câu
                                chúc được chăm chút lại gây ấn tượng hơn rất nhiều.
                            </p>
                            <a href="#" class="news-link">Xem chi tiết</a>
                        </div>
                    </article>
                    ...
                    <article class="news-card" data-category="story">
                        ...
                        <div class="news-content">
                            ...
                            <h2 class="news-heading">Một ngày chuẩn bị 20 đơn "tỏ tình" cùng Nhà Tớ</h2>
                            <p class="news-excerpt">
                                Có những ngày Tiệm nhận rất nhiều đơn "bí mật" – người gửi giấu tên, chỉ nhắn một
                                câu:
                                "Nhờ Tiệm giúp em nói phần còn lại nhé…".
                            </p>
                            <a href="#" class="news-link">Xem chi tiết</a>
                        </div>
                    </article>
                    ...
                    <article class="news-card" data-category="tips">
                        ...
                        <div class="news-content">
                            ...
                            <h2 class="news-heading">Tặng hoa với ngân sách vừa phải nhưng vẫn thật chỉn chu</h2>
                            <p class="news-excerpt">
                                Bạn không cần chi quá nhiều để có một bó hoa xinh – quan trọng là chọn đúng concept,
                                tone màu và kiểu gói phù hợp với người nhận.
                            </p>
                            <a href="#" class="news-link">Xem chi tiết</a>
                        </div>
                    </article>
                    ...
                    <article class="news-card" data-category="proposal">
                        ...
                        <div class="news-content">
                            ...
                            <h2 class="news-heading">Bó hoa cầu hôn hoàn hảo: Chọn sao cho đúng ý?</h2>
                            <p class="news-excerpt">
                                Một khoảnh khắc trọng đại cần một bó hoa đặc biệt. Hãy để chúng tôi giúp bạn tìm
                                được "chìa khóa" cho trái tim người ấy.
                            </p>
                            <a href="#" class="news-link">Xem chi tiết</a>
                        </div>
                    </article>
                    ...
                    <article class="news-card" data-category="tips">
                        ...
                        <div class="news-content">
                            ...
                            <h2 class="news-heading">5 bí quyết giữ hoa tươi lâu mà ít ai biết</h2>
                            <p class="news-excerpt">
                                Đừng để bó hoa đẹp của bạn chỉ tồn tại vài ngày. Với những mẹo đơn giản này, hoa có
                                thể tươi hơn bạn nghĩ rất nhiều.
                            </p>
                            <a href="#" class="news-link">Xem chi tiết</a>
                        </div>
                    </article>
                ...
                <div class="load-more-section">
                    <button class="load-more-btn" id="loadMoreBtn">Xem thêm bài viết</button>
                </div>
            </div>
            ...
            <aside class="news-sidebar">
                <div class="sidebar-widget">
                    ...
                    <ul class="recent-posts">
                        <li class="recent-post-item">
                            <div class="recent-post-title">Hoa pastel cho mùa cuối năm</div>
                            <div class="recent-post-date">09/11/2025</div>
                        </li>
                        <li class="recent-post-item">
                            <div class="recent-post-title">5 mẫu bó hoa "an toàn" nhưng không nhàm chán</div>
                            <div class="recent-post-date">03/11/2025</div>
                        </li>
                        <li class="recent-post-item">
                            <div class="recent-post-title">Chọn hoa theo cung hoàng đạo – bạn đã thử chưa?</div>
                            <div class="recent-post-date">27/10/2025</div>
                        </li>
                        <li class="recent-post-item">
                            <div class="recent-post-title">Bí mật của những bó hoa "triệu view"</div>
                ...
                <div class="sidebar-widget">
                    ...
                    <p class="sidebar-note">
                        Nếu bạn có một câu chuyện về hoa cùng Tiệm, hãy nhắn cho tụi mình –
                        biết đâu câu chuyện đó sẽ xuất hiện trong chuyên mục "Story từ Nhà Tớ" 💌
                    </p>
                </div>
            </aside>
        </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function performSearch() {
            ...
            let foundCount = 0;
            newsCards.forEach(card => {
                const title = card.querySelector('.news-heading').textContent.toLowerCase();
            ...
            if (foundCount === 0) {
                alert('Không tìm thấy bài viết phù hợp với từ khóa: "' + searchTerm + '"');
            }
        }
...
<script type="text/javascript" src="//cdn.hstatic.net/themes/200000846175/1001403720/14/main-scripts.js?v=245"
        defer></script>
<script type="text/javascript" src="//cdn.hstatic.net/themes/200000846175/1001403720/14/main-page.js?v=245"
        defer></script>
